...
func testChannel(channel *model.Channel, testModel string, endpointType string, isStream bool) testResult {
	...
	isStream = resolveChannelTestStream(channel, endpointType, isStream)
...
func shouldForceStreamForChannelTest(channel *model.Channel, endpointType string) bool {
	...
	return strings.TrimSpace(endpointType) != string(constant.EndpointTypeOpenAIResponseCompact)
}

func resolveChannelTestStream(channel *model.Channel, endpointType string, requestedStream bool) bool {
	if shouldForceStreamForChannelTest(channel, endpointType) {
		return true
	}
	if strings.TrimSpace(endpointType) == string(constant.EndpointTypeOpenAIResponseCompact) {
		return false
	}
...
func shouldUseStreamForAutomaticChannelTest(channel *model.Channel) bool {
	return shouldForceStreamForChannelTest(channel, "")
}
