...
def _include_object(object, name, type_, reflected, compare_to):  # noqa: A002
    """Skip tables that exist in the DB but are not defined as ORM models.

    These are managed by raw-SQL migrations and should not appear as
    'pending upgrade operations' in alembic check.
    """
