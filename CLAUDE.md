...
- **What it does**: Enterprise LLM gateway that pools Claude Max and OpenAI Codex OAuth subscriptions across developers. Exposes an OpenAI-compatible `/v1` API, proxying requests to credential pools. Handles billing quotas and usage tracking.
